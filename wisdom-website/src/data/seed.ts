...
// ── Events ─────────────────────────────────────────────────────────────────
const fd = (days: number) => new Date(Date.now() + days * 24 * 60 * 60 * 1000).toISOString().split('T')[0];
...
const SEED_EVENTS: Event[] = [
  {
    ...
    time: '18:00',
    location: 'Sydney',
    description: 'An evening of networking for women in STEM. Meet peers, mentors, and industry leaders over drinks and conversation.',
  ...
  },
  {
    ...
    time: '12:00',
    location: 'Sydney',
    description: 'Informal lunch catchup for biotech professionals and students in Sydney. Share what you\'re working on and connect with the community.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
  {
    ...
    time: '10:00',
    location: 'Melbourne',
    description: 'Connect with top engineering firms offering internship opportunities for women in STEM. Bring your CV and meet hiring managers.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
  {
    id: 'event-4',
    title: 'WISDOM Mentorship Program Launch',
    type: 'Mentorship Opportunity',
    date: fd(12),
    time: '14:00',
    location: 'Sydney',
    description: 'Launch event for the WISDOM mentorship program. Meet your potential mentors and learn how the program works.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
  {
    id: 'event-5',
    title: 'Women in Data Science — Panel Discussion',
    type: 'Networking',
    date: fd(7),
    time: '17:30',
    location: 'Sydney',
    description: 'A panel of leading women in data science share their career journeys, challenges, and advice for those entering the field.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
  {
    id: 'event-6',
    title: 'Mathematics & Actuarial Careers Expo',
    type: 'Internship Opportunity',
    date: fd(22),
    time: '09:00',
    location: 'Sydney',
    description: 'Explore career pathways in actuarial science, statistics, and quantitative finance. Firms from insurance, banking, and consulting will be present.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
  {
    ...
    time: '10:00',
    location: 'Melbourne',
    description: 'A hands-on workshop covering literature review, research methodology, and academic writing for early-career researchers.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
  {
    ...
    time: '13:00',
    location: 'Sydney',
    description: 'Book a 30-minute one-on-one session with an experienced STEM professional. Topics can include career advice, CV review, or technical guidance.',
    organiserId: ADMIN_ID,
    createdAt: NOW,
  },
];
